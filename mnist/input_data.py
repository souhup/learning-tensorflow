...
def read_data_sets(train_dir, one_hot=False, dtype=tf.float32):
    ...
    train_images = extract_images(os.path.join(train_dir, TRAIN_IMAGES))
    train_labels = extract_labels(os.path.join(train_dir, TRAIN_LABELS), one_hot=one_hot)
    test_images = extract_images(os.path.join(train_dir, TEST_IMAGES))
    test_labels = extract_labels(os.path.join(train_dir, TEST_LABELS), one_hot=one_hot)
